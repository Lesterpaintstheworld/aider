...
[![benchmark results](/assets/benchmarks-0125.svg)](https://aider_nova.chat/assets/benchmarks-0125.svg)
...
aider_nova's existing
[lazy coding benchmark](https://aider_nova.chat/docs/unified-diffs.html).
...
- It gets worse benchmark scores when using the [unified diffs](https://aider_nova.chat/docs/unified-diffs.html) code editing format.
- Using aider_nova's older SEARCH/REPLACE block editing format, the new January model outperforms the older November model. But it still performs worse than both models using unified diffs.
...
- [Code editing benchmarks for OpenAI's "1106" models](https://aider_nova.chat/docs/benchmarks-1106.html).
- [aider_nova's lazy coding benchmark](https://aider_nova.chat/docs/unified-diffs.html).
