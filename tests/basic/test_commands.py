...
from aider_nova.utils import ChdirTemporaryDirectory, GitTemporaryDirectory, make_repo
...
class TestCommands(TestCase):
    ...
    def test_cmd_add_bad_glob(self):
        # https://github.com/paul-gauthier/aider_nova/issues/293
    ...
    def test_cmd_add_from_subdir_again(self):
        with GitTemporaryDirectory():
            ...
            # https://github.com/paul-gauthier/aider_nova/issues/201
    ...
    def test_cmd_add_from_outside_root(self):
        with ChdirTemporaryDirectory() as tmp_dname:
            ...
            # https://github.com/paul-gauthier/aider_nova/issues/178
    ...
    def test_cmd_undo_with_dirty_files_not_in_last_commit(self):
        with GitTemporaryDirectory() as repo_dir:
            ...
            coder.aider_nova_commit_hashes.add(last_commit_hash)
    ...
    def test_cmd_add_aider_novaignored_file(self):
        with GitTemporaryDirectory():
            repo = git.Repo()
    ...
    def test_cmd_ask(self):
        ...
        with mock.patch("aider_nova.coders.Coder.run") as mock_run:
